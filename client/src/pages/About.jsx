   ...
   >
      ...
      <div className={`md:flex items-center justify-between group ${index % 2 === 0 ? 'flex-row-reverse' : ''}`}>
         ...
         <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 top-0 h-full flex flex-col items-center">
            <div className="w-8 h-8 rounded-full bg-white dark:bg-[#0A0A0A] border border-slate-200 dark:border-purple-500/50 flex items-center justify-center z-10 shadow-lg dark:shadow-[0_0_15px_rgba(168,85,247,0.4)] group-hover:scale-110 transition-transform">
               <div className="w-2 h-2 bg-purple-500 dark:bg-purple-400 rounded-full animate-pulse" />
            </div>
            {!isLast && <div className="w-px h-full bg-gradient-to-b from-purple-500/30 to-transparent" />}
         </div>

         {/* The Content Card */}
         <div className={`md:w-[45%] mb-12 relative`}>
            <TiltCard>
               {/* 🟢 FIX: Card background and text colors */}
               <div className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-purple-300 dark:hover:border-purple-500/30 transition-all shadow-lg dark:shadow-none">
                  <div className="flex items-center gap-3 mb-2">
                     <span className="px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider bg-purple-100 dark:bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-purple-500/20">
                        {item.period}
                     </span>
   ...
   const timeline = [
      {
         ...
         organization: 'Kamla Nehru Institute of Technology, Sultanpur',
         period: '2022 – 2026',
      ...
      },
      {
         ...
         period: '2022 – Present',
         description: 'Achieved 5★ on CodeChef and Knight rank on LeetCode. Solved 3000+ problems to sharpen problem-solving reflexes.',
      },
   ]
         ...
         <div className="container-custom relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-16 mb-24 items-start">
               ...
               <div className="lg:col-span-5 relative">
                  <TiltCard>
                     <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-[#0A0A0A] border border-slate-200 dark:border-white/10 p-1 shadow-2xl">
                        ...
                        <div className="bg-slate-50 dark:bg-[#0F0F0F] rounded-[1.4rem] p-8 relative">
                           {/* ID Header */}
                           <div className="flex justify-between items-center mb-8 border-b border-slate-200 dark:border-white/5 pb-4">
                              ...
                              <div className="flex items-center gap-2">
                                 ...
                                 <span className="text-xs font-bold text-emerald-600 dark:text-emerald-500 tracking-wider">ONLINE</span>
                              </div>
                           </div>
                           ...
                           <div className="space-y-6">
                              <div>
                                 ...
                                 <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{personalInfo.name}</h2>
                              </div>

                              <div>
                                 <p className="text-xs text-slate-500 uppercase tracking-widest mb-1">Class / Role</p>
                                 <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-purple-100 dark:bg-purple-500/10 border border-purple-200 dark:border-purple-500/20 text-purple-600 dark:text-purple-400 text-sm font-medium">
                              ...
                              <div>
                                 ...
                                 <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                    ...
                                    Currently leveling up in <span className="text-slate-900 dark:text-white font-medium">Full Stack Development</span> and
                                    <span className="text-slate-900 dark:text-white font-medium"> Competitive Programming</span>.
                                 </p>
                              </div>
                           </div>

                           {/* Footer Decoder */}
                           <div className="mt-8 pt-4 border-t border-slate-200 dark:border-white/5 flex justify-between items-center text-[10px] text-slate-500 font-mono">
                              <span>LOC: INDIA</span>
               ...
               <div className="lg:col-span-7 space-y-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                     {highlightStats.map((stat, i) => (
                        <motion.div
                           ...
                           className="bg-white dark:bg-[#0A0A0A] border border-slate-200 dark:border-white/10 p-4 rounded-2xl text-center group hover:border-purple-400 dark:hover:border-purple-500/30 transition-colors shadow-sm dark:shadow-none"
                        >
                           <div className={`mx-auto w-10 h-10 rounded-full bg-slate-100 dark:bg-white/5 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform ${stat.color}`}>
                              <stat.icon size={20} />
                           </div>
                           <h4 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">{stat.value}</h4>
                  ...
                  {/* 2. Tech Arsenal */}
                  <div className="bg-white/50 dark:bg-[#0A0A0A]/50 border border-slate-200 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm shadow-sm dark:shadow-none">
                     <div className="flex items-center gap-3 mb-6">
                        <Cpu className="text-purple-600 dark:text-purple-400" size={20} />
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white">Equipped Arsenal</h3>
                     </div>
                     <div className="flex flex-wrap gap-2">
                        {coreTech.map((tech, i) => (
                           <motion.div
                              ...
                              className="px-4 py-2 rounded-lg bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 text-sm font-medium hover:bg-slate-200 dark:hover:bg-white/10 hover:text-purple-600 dark:hover:text-white hover:border-purple-300 dark:hover:border-white/20 transition-all cursor-default flex items-center gap-2"
                           >
            ...
            <div className="max-w-4xl mx-auto">
               <div className="text-center mb-16">
                  <span className="inline-block p-3 rounded-full bg-white dark:bg-white/5 border border-slate-200 dark:border-white/5 mb-4 text-purple-600 dark:text-purple-400 shadow-sm dark:shadow-none">
                     <Sparkles size={20} />
                  </span>
                  <h3 className="text-3xl font-bold text-slate-900 dark:text-white">Evolution Log</h3>
               </div>
